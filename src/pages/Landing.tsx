        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/onboarding" className="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-full text-white bg-brand-600 hover:bg-brand-700 shadow-sm transition-all hover:shadow-md">
                Prueba Gratis
              </Link>
            </div>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-4 pt-2 pb-6 space-y-1">
                ...
                <Link to="/onboarding" onClick={() => setIsMobileMenuOpen(false)} className="block w-full text-center mt-4 px-5 py-3 border border-transparent text-base font-medium rounded-xl text-white bg-brand-600 hover:bg-brand-700">
                  Prueba Gratis
                </Link>
              </div>
            </motion.div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <Link to="/onboarding" className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-base font-medium rounded-full text-white bg-slate-900 hover:bg-slate-800 shadow-lg hover:shadow-xl transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-slate-800 rounded-3xl p-8 border border-slate-700 flex flex-col">
              ...
              <Link to="/onboarding" className="w-full block text-center py-3 px-6 rounded-xl font-medium bg-slate-700 hover:bg-slate-600 text-white transition-colors">
                Elegir Básico
              </Link>
            </div>
            ...
            <div className="bg-brand-600 rounded-3xl p-8 border border-brand-500 flex flex-col relative transform md:-translate-y-4 shadow-2xl shadow-brand-900/50">
              ...
              <Link to="/onboarding" className="w-full block text-center py-3 px-6 rounded-xl font-medium bg-white text-brand-900 hover:bg-slate-50 transition-colors">
                Elegir Corporativo
              </Link>
            </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 md:p-16">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl">
                <h3 className="text-2xl font-bold text-slate-900 mb-6">Comienza tu Prueba Gratis</h3>
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <Link to="/onboarding" className="w-full block text-center py-4 px-6 rounded-xl font-medium text-white bg-brand-600 hover:bg-brand-700 shadow-lg hover:shadow-xl transition-all">
                    Empezar Prueba
                  </Link>
